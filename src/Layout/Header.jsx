    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 mb-5 transition-all duration-300 ${
          isScrolled ? 'bg-white/95 glass-morphism shadow-lg' : 'bg-white/70'
        }`}
      >
        <div className="mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link
                to="/"
                className="text-slate-700 hover:text-orange-600 transition-colors font-inter font-medium cursor-pointer"
              >
                Home
              </Link>
              <Link
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden mt-4 bg-slate-900/95 glass-morphism rounded-lg p-4 z-[60] relative">
              <nav className="flex flex-col space-y-4">
                <Link
                  to="/"
                  className="text-white hover:text-orange-400 transition-colors font-inter cursor-pointer"
                >
                  Home
                </Link>
                <Link
