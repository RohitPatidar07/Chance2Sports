  ...
  return (
    <section className="py-20 bg-gray-900 text-white relative overflow-visible">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative">
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className="w-28 h-28 bg-white text-center rounded-2xl shadow-xl flex flex-col items-center justify-center text-black"
                  >
        ...
        {/* Right Slide-In Panel (Not Fullscreen) */}
   <AnimatePresence>
  {selectedCard && (
    <motion.div
      className="absolute top-0 right-0 h-full w-full sm:w-[480px] bg-[white] z-30 px-6 py-8 shadow-2xl rounded-tl-[180px] overflow-y-auto border-l border-gray-700 flex flex-col"
      initial={{ x: '100%' }}
      animate={{ x: 0 }}
      exit={{ x: '100%' }}
